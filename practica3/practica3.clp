; [CASTELLANO]
; Practica 3: Sistema Experto Simple
; Asignatura: Ingenieria del Conocimiento
; Autor: Valentino Lugli (Github: @RhinoBlindado)
; Fecha: Abril 2021

; [ENGLISH]
; Practice 3: Simple Expert System
; Course: Knowledge Engineering
; Author: Valentino Lugli (Github: @RhinoBlindado)
; Date: April 2021

; Nota: Se adjunta el fichero "arbolDecision.png" en el que se muestra el arbol de decisión en el que
; se ha basado esta práctica. Se ha ampliado ligeramente los valores que aceptan las ramas y se 
; añadió una pregunta adicional que es "¿Te gusta programar?".
